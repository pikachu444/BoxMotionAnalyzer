...
FIELD_LABELS = {
    ...
    "pose_lpf_cutoff": "Cutoff (Hz):",
    "pose_lpf_order": "Order:",
    ...
    "velocity_lowpass_filter": "Velocity Butterworth low-pass filter",
    "velocity_lpf_cutoff": "Cutoff (Hz):",
    "velocity_lpf_order": "Order:",
