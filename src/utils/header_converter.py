...
def get_conversion_rules() -> list:
    ...
    rules = [
        ...
        (re.compile(f"^{DropPostureCols.BETA_DEG}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE, HeaderL3.DROP_BETA_DEG)),
        (re.compile(f"^{DropPostureCols.THETA_LONG_DEG}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE, HeaderL3.DROP_THETA_LONG_DEG)),
        (re.compile(f"^{DropPostureCols.THETA_SHORT_DEG}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE, HeaderL3.DROP_THETA_SHORT_DEG)),
        (re.compile(f"^{DropPostureCols.CMIN_INDEX}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE, HeaderL3.DROP_CMIN_INDEX)),
        (re.compile(f"^{DropPostureCols.DELTA_H_MM}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE, HeaderL3.DROP_DELTA_H_MM)),
        (re.compile(f"^{DropPostureSummaryCols.BETA_AT_T1_MINUS_DEG}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_BETA_AT_T1_MINUS_DEG)),
        (re.compile(f"^{DropPostureSummaryCols.MAX_BETA_DEG}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_MAX_BETA_DEG)),
        (re.compile(f"^{DropPostureSummaryCols.THETA_LONG_AT_T1_MINUS_DEG}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_THETA_LONG_AT_T1_MINUS_DEG)),
        (re.compile(f"^{DropPostureSummaryCols.MAX_ABS_THETA_LONG_DEG}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_MAX_ABS_THETA_LONG_DEG)),
        (re.compile(f"^{DropPostureSummaryCols.THETA_SHORT_AT_T1_MINUS_DEG}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_THETA_SHORT_AT_T1_MINUS_DEG)),
        (re.compile(f"^{DropPostureSummaryCols.MAX_ABS_THETA_SHORT_DEG}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_MAX_ABS_THETA_SHORT_DEG)),
        (re.compile(f"^{DropPostureSummaryCols.DELTA_H_AT_T1_MINUS_MM}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_DELTA_H_AT_T1_MINUS_MM)),
        (re.compile(f"^{DropPostureSummaryCols.MAX_DELTA_H_MM}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_MAX_DELTA_H_MM)),
        (re.compile(f"^{DropPostureSummaryCols.CMIN_AT_T1_MINUS_INDEX}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_CMIN_AT_T1_MINUS_INDEX)),
        (re.compile(f"^{DropPostureSummaryCols.T1_MINUS_TIME_SEC}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_T1_MINUS_TIME_SEC)),
        (re.compile(f"^{DropPostureSummaryCols.REFERENCE_FACE}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_REFERENCE_FACE)),
        (re.compile(f"^{DropPostureSummaryCols.LONG_AXIS}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_LONG_AXIS)),
        (re.compile(f"^{DropPostureSummaryCols.SHORT_AXIS}$"),
        ...
        (re.compile(f"^{DropPostureSummaryCols.CONTACT_STATE}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_CONTACT_STATE)),
        (re.compile(f"^{DropPostureSummaryCols.CONTACT_CONFIDENCE}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_CONTACT_CONFIDENCE)),
        (re.compile(f"^{DropPostureSummaryCols.CONTACT_DETECTION_METHOD}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_CONTACT_DETECTION_METHOD)),
        (re.compile(f"^{DropPostureSummaryCols.IMPACT_DETECTED}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_IMPACT_DETECTED)),
        (re.compile(f"^{DropPostureSummaryCols.SUSTAINED_CONTACT_DETECTED}$"),
         lambda m: (HeaderL1.ANALYSIS, HeaderL2.DROP_POSTURE_SUMMARY, HeaderL3.DROP_SUSTAINED_CONTACT_DETECTED)),
