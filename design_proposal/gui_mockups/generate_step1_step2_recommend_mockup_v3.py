...
class Step1MockWindowV3(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Step 1 - Raw Data Processing (v3)')
...
class Step2MockWindowV3(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Step 2 - Results Analysis (v3)')
...
class PopupMockWindowV3(QDialog):
    def __init__(self):
        super().__init__()
...
if __name__ == '__main__':
    ...
    step1 = Step1MockWindowV3()
    step2 = Step2MockWindowV3()
    popup = PopupMockWindowV3()

    save_widget(step1, os.path.join(out_dir, 'step1_improved_mock_v3.png'))
    save_widget(step2, os.path.join(out_dir, 'step2_improved_mock_v3.png'))
    save_widget(popup, os.path.join(out_dir, 'step2_popup_improved_mock_v3.png'))

    print('Saved:')
    print(os.path.join(out_dir, 'step1_improved_mock_v3.png'))
    print(os.path.join(out_dir, 'step2_improved_mock_v3.png'))
    print(os.path.join(out_dir, 'step2_popup_improved_mock_v3.png'))
