...
- [ ] Complete #77 reviewed target-posture error and intended first-contact agreement. Independently labeled real metrics and comparison validation remain pending in #78; the experimental first unit does not complete the entire issue.
