...
## TODO List
- [O] #118: Implement recorded first-event consistency, state-specific confidence and visible exclusions. Local 244-test verification, final 5-test GUI rerun and independent correction review passed; see `drop_result_comparison_plan.md`. PR/required CI publication is the remaining delivery step. Keep #118/#111 open and do not merge or enable auto-merge. #119 metric-wise deduplication and #120 bounded event evidence are separate follow-ups.
