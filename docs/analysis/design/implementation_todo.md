...
- [ ] #121 → #123 → #117 → #122: Continue sequentially from each merged main. The 2026-09-18 user request authorizes implementation, verification, independent review, fixes, PR, required CI and merge without another approval.
