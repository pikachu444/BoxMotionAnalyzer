...
- [ ] #122: Continue from merged #117 main. The 2026-09-18 user request authorizes implementation, verification, independent review, fixes, PR, required CI and merge without another approval.
