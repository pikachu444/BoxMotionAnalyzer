...
첫 구현 단위에 포함되지 않은 것은 목표 자세 오차, 시험 기록의 목표 접촉과 실제 접촉 일치, 실측 접촉 시점·미분 정확도 검증이다. #77은 이 항목들 때문에 계속 열린다. 실측 비교·방향·물리 검증은 #78에서 pending으로 추적한다.
