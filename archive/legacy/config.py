# --- START OF FILE config.py (Revised based on feedback) ---
import numpy as np
...
FLOOR_VIS_SCALE_FACTOR = 1.0   # Default scale factor. 1.0 means floor visual extent matches box's L and W projection.
...
# --- END OF FILE config.py (Revised based on feedback) ---